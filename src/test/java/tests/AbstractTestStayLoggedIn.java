...
public class AbstractTestStayLoggedIn
{
    public static TestContext context = new TestContext();
    public static Browser browser = context.doCreateBrowserWithProfile();
    //create a session with my saved Chrome profile (signed in and cookies enabled)
